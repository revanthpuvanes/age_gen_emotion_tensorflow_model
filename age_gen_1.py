...
emotion_model.load_weights('./models/_mini_XCEPTION.86-0.65.hdf5')
	...
	for (x,y,w,h) in faces:
		if w > 130: #ignore small faces
			...
			try:
				...
				detected_face_1 = cv2.resize(detected_face_1, (64, 64)) #resize to 48x48
				...
				# emotion model
				predictions = emotion_model.predict(img_pixels_1)
				emo_index = np.argmax(predictions[0])
